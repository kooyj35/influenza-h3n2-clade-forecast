"""
H3N2 Influenza Clade Prediction Model (Balanced + Threshold 최적화)
===================================================================
목적: 다음 해 지배 clade(CR: Candidate Recommendation)를 예측
전략: Balanced 가중치 + Threshold 최적화 + ElasticNet 정규화
...
if __name__ == "__main__":
    ...
    # ================================================================
    # Step 3: 시간순 교차검증 (Expanding Window)
    # ================================================================
    print("\n" + "=" * 60)
    ...
    print(f"  Threshold:    {micro['threshold']:.3f}")
  ...
  Performance (Micro Average):
    - Precision:    {micro['precision']:.3f}
    - Recall:       {micro['recall']:.3f}
    - F1:           {micro['f1']:.3f}
